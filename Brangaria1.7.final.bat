...
echo 2. Wow, that's really all I can think of. 
pause>null
cls 
...
set /p name=Name: 
cls 
echo Hello, %name%! As a hero in training, you will accept the path of adventure, 
...
pause>null 
cls 
echo "Adventure awaits!" you shout as you exit the room, beginning a quest of a lifetime.
pause>null 
goto armara_street 
...
cls 
color 0f 
if %location& !equ armara_street (
echo You walk back to your small wooden house, located 
...
cls 
color 0f 
echo Your mind seems suddenly devoid of emotion, as if someone 
echo in the sky flipped a switch. 
pause>null 
cls 
echo What do you want to do? 
echo. 
...
pause>null 
cls 
echo As you open the letter, a small wooden key falls out. 
pause>null 
cls 
echo You pick it up. 
paue 
cls 
echo As you read it, you see it is inscribed with a note. 
echo "look inside the tree for my message". 
pause>null 
cls 
echo If only you knew what that could mean... 
pause>null 
cls 
echo You pocket the key. 
pause>null 
set /a key1=%key1%+1 
goto livechoice 
:putcandle 
color 0f 
cls 
echo You place a new candle in the candleholder and light it. 
pause>null 
cls 
echo It blazes forth with a light unparallelled to any other. 
pause>null 
cls 
echo Suddenly, as if by magic, it begins to move. 
echo More discernable features begin to show as a face 
echo forms. 
pause>null 
cls 
echo You back away slowly. 
pause>null 
cls 
echo Suddenly the candle bursts into life with a shower of wax! 
pause>null 
cls 
echo It shouts- 
echo. 
color 0e 
echo HER NAME IS CATHERINE! 
echo. 
color 0f 
echo then pools limply into a pile of ashes. 
pause>null 
cls 
color 0a 
echo What was that?! 
...
cls 
color 0c 
echo Oh wait, all the food here is the same! No need to choose!
pause>null 
:foodchoice 
cls 
color 0c 
set location=foodchoice 
echo Anyways, it's 1 coin for 2 pieces of food. 
...
echo has been set up. As you approach the building, a burly 
...
echo 0               Keys              0 
echo 00000000000000000000000000000000000 
echo 0 Wooden Key...............%key1% 0 
echo 0 Iron Key.................%key2% 0 
echo 0 Gold Key.................%key3% 0 
echo 0 Platinum Key.............%key4% 0 
echo 0 Particle Key.............%key5% 0 
echo 00000000000000000000000000000000000 
pause>null 
goto inventory 
:money_inventory 
...
echo 0              Swords             0 
echo 00000000000000000000000000000000000 
echo 0 Stone Sword %weaponexist1% 
echo 0 Iron Sword %weaponexist2% 
echo 0 Steel Sword %weaponexist3%
echo 0 Tunstgen Sword %weaponexist4%
echo 0 Armarite Sword %weaponexist5% 
echo 00000000000000000000000000000000000 
...
echo 0 Swords                             0 
echo 00000000000000000000000000000000000000 
echo 0 1. Stone Sword %weaponexist1% 
echo 0 2. Iron Sword %weaponexist2% 
echo 0 3. Steel Sword %weaponexist3%
echo 0 4. Tunstgen Sword %weaponexist4% 
echo 0 5. Armarite Sword %weaponexist5% 
echo 0 6. Keep Current Weapon 
echo 00000000000000000000000000000000000000 
echo. 
set /p wpneqp=Choice: 
if %wpneqp% equ 1 ( 
