...
echo 00000000000000000000000000
echo.
set /p mainmenu=Choice: 
if %mainmenu% equ 1 goto start
if %mainmenu% equ 2 goto newfile
if %mainmenu% equ 3 goto tutorial
...
echo 0       Johnny's Weaponsmithing              0
echo 0000000000000000000000000000000000000000000000
echo 0 1. Wood Sword.........1 coin.....1 Attack  0
echo 0 2. Iron Sword.........4 coins....3 Attack  0
echo 0 3. Steel Sword........6 coins....4 Attack  0
echo 0 4. Tunstgen Sword.....10 coins...10 Attack 0
echo 0 5. Armarite Sword.....100 coins..25 Attack 0
echo 0000000000000000000000000000000000000000000000
echo 0 6. Wood Axe...........1 coin.....2 Attack  0
echo 0 7. Iron Axe...........5 coins....4 Attack  0
echo 0 8. Steel Axe..........7 coins....5 Attack  0
echo 0 9. Tunstgen Axe.......11 coins...11 Attack 0
echo 0 10.Armarite Axe.......125 coins..30 Attack 0
echo 0000000000000000000000000000000000000000000000
echo 0 11.Wood Armor.........2 coins...3 Defense  0
echo 0 12.Iron Armor.........10 coins..8 Defense  0
...
if %armaratavernchoice% equ 3 goto getadrink
goto sit_at_armara_bar_stool
